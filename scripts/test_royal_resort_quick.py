#!/usr/bin/env python3
"""
Quick test for Royal Resort fixes
"""
import sys
import os
        ...
        if scraper.setup_browser():
            ...
            if success:
                ...
                if properties:
                    ...
                    print('❌ No property elements found')
                    return False
            else:
                print('❌ Navigation completely failed')
                return False
...
if __name__ == "__main__":
    ...
    if success:
        print('\n🎉 Royal Resort fixes are working!')
    else:
        print('\n⚠️ Royal Resort still needs more work')